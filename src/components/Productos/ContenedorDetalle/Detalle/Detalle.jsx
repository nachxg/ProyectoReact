...
export const Detalle = ({ producto }) => {
  ...
  return (
    <div className='w-full flex flex-row pt-3 h-[67vh] justify-between items-center gap-5 *:h-full *:flex'>
      ...
      <div className='relative items-start w-4/5 bg-neutral-100 dark:bg-neutral-950 px-5 pt-5 pb-0 rounded-md shadow-md shadow-neutral-400 dark:shadow-black flex-row'>
        ...
        <div className='w-fit h-full px-5 pt-5 pb-0 gap-3 flex flex-col justify-center'>
          ...
          <div className='flex items-end justify-end flex-row gap-3 mt-auto select-none'>

            <ItemCount stock={producto.stock}/>

            <div className='btn-trans bg-[#d37912] hover:h-12 rounded-tl-xl rounded-tr-xl group cursor-pointer h-10 w-48 relative pl-2 pb-1 text-black flex justify-center items-center'>
              agregar al carrito
